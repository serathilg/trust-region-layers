...
from trust_region_projections.utils.network_utils import polyak_update
...
class DoubleCritic(TargetCritic):
    ...
    def __init__(self, critic_network1: Union[QFNet, VFNet], critic_network2: Union[QFNet, VFNet]):
    ...
    def forward(self, x, *args, **kwargs):
        return ch.min(super(DoubleCritic, self).forward(x, *args, **kwargs),
    ...
    def target(self, x, *args, **kwargs):
        return ch.min(super(DoubleCritic, self).target(x, *args, **kwargs),
